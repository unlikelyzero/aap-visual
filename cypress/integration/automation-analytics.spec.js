...
describe('Automation Analytics', () => {
  ...
  it('Verify Clusters View - Basic', () => {
    cy.intercept('GET', '/api/tower-analytics/v0/chart30/', { fixture: 'automation-analytics/chart30-normal.json' }).as('chart30')
    cy.intercept('GET', '/api/tower-analytics/v0/modules/', { fixture: 'automation-analytics/modules30-normal.json'}).as('modules30')
    cy.intercept('GET', '/api/tower-analytics/v0/templates/', { fixture: 'automation-analytics/templates30-normal.json'}).as('templates30')
    
    cy.visit('https://cloud.redhat.com/ansible/automation-analytics/clusters')
  ...
  it('Verify Clusters View - Empty', () => {
    cy.intercept('GET', '/api/tower-analytics/v0/chart30/', { fixture: 'automation-analytics/chart30-empty.json' }).as('chart30')
  ...
  it('Verify Organization Statistics View - Empty', () => {
    cy.visit('https://cloud.redhat.com/ansible/automation-analytics/organization-statistics')
    cy.wait('@token')
    cy.intercept('GET', 'https://cloud.redhat.com/api/rbac/v1/access/?application=&limit=100', {statusCode: 200});
  ...
  it('Verify Job Explorer View - Empty', () => {
    cy.visit('https://cloud.redhat.com/ansible/automation-analytics/job-explorer')
    cy.wait('@token')
    cy.intercept('GET', 'https://cloud.redhat.com/api/rbac/v1/access/?application=&limit=100', {statusCode: 200});
  ...
  it('Verify Notifications View - Empty', () => {
    cy.visit('https://cloud.redhat.com/ansible/automation-analytics/notifications')
    cy.wait('@token')
    cy.intercept('GET', 'https://cloud.redhat.com/api/rbac/v1/access/?application=&limit=100', {statusCode: 200});
